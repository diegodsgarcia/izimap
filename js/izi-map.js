function IziMap(element, lat, lng) {
  ...
  this.setCoordinate = function(lat, lng) {
    mainMap.setCenter({lat: lat, lng: lng});
  }

  this.addressToCoordinate = function(address, callback) {
  ...
  this.coordinateToAddress = function(latLng, callback) {
  ...
  this.setMarkCoordinate = function(latLng) {
    latLng.forEach(function(data) {
      var marker = new google.maps.Marker({
  ...
  this.setMarkCoordinateWindow = function(latLng, contentString) {
